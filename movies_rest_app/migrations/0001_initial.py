    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('actor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='movies_rest_app.actor')),
                ('movie', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='movies_rest_app.movie')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='movie',
            name='actors',
            field=models.ManyToManyField(through='movies_rest_app.MovieActor', to='movies_rest_app.actor'),
        ),
    ]
